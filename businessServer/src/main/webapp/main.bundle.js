...
var ExploreComponent = (function () {
    ...
    ExploreComponent.prototype.getGuessMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/stream?num=100&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
                _this.movies = data['movies'];
            }
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.getGuessMovies = function () {
        var _this = this;
        this.httpService
            .get(__WEBPACK_IMPORTED_MODULE_4__model_constant__["a" /* constant */].BUSSINESS_SERVER_URL + 'rest/movie/stream?num=6&username=' + this.loginService.user.username)
            .subscribe(function (data) {
            if (data['success'] == true) {
